...
## 6. Reglas de calidad transversales

- Mantener separacion por capas (entrypoint/application/domain/infrastructure).
- DTOs de API separados de entidades de dominio o persistencia.
- Dependencias orientadas hacia adentro (Clean Architecture).
- Tests:
	- unit tests para use cases y servicios,
	- tests de rutas para contratos HTTP,
	- evitar acoplamiento a infraestructura en tests unitarios.
