---
name: "Payload Logging Trace Implementer"
...
# Payload Logging Trace Implementer
...
Always load and apply the skill `logging-kotlin` for logging conventions, levels, privacy rules, and `X-Request-ID`/`X-Correlation-ID` traceability patterns of this project.
