---
name: middleware-webscraping-contract
...
- `src/main/kotlin/es/mycardiochef/middleware/infrastructure/client/ScrapingServiceClient.kt`
- `src/main/kotlin/es/mycardiochef/middleware/core/di/KoinModules.kt`
