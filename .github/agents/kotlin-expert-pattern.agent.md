...
- User needs CI/CD → delegate to `devops-agent`
- User needs a full MCP server scaffold → delegate to `kotlin-mcp-expert`
- User needs code quality audit → delegate to `Kotlin Server Quality Analyst`
