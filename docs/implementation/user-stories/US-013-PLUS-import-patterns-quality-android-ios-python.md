...
| `android-quality-skill/SKILL.md` | `.github/skills/android-quality-skill/SKILL.md` | `skills/android/compose/android-quality/SKILL.md` |
| quality rules critical/high/medium/low | `.github/android-quality-rules/` | `skills/android/compose/android-quality/references/` |
| `android-expert-pattern.agent.md` | `.github/agents/` | `agents/android/compose/android-expert-pattern.agent.md` |
| `android-quality.agent.md` | `.github/agents/` | `agents/android/compose/android-quality.agent.md` |
| `android-expert-patterns.prompt.md` | `.github/prompts/` | `prompts/android/compose/android-expert-patterns.prompt.md` |
| `android-quality-analyze.md` | `.github/prompts/` | `prompts/android/compose/android-quality-analyze.prompt.md` |

### iOS (enriquecimiento sobre US-013)
| Asset | Origen | Destino en este repo |
|---|---|---|
| `ios-quality-skill/SKILL.md` | `.github/skills/ios-quality-skill/SKILL.md` | `skills/ios/swiftui/ios-quality/SKILL.md` |
| quality rules critical/high/medium/low | `.github/ios-quality-rules/` | `skills/ios/swiftui/ios-quality/references/` |
| `ios-quality.agent.md` | `.github/agents/` | `agents/ios/swiftui/ios-quality.agent.md` |
| `ios-expert-patterns.prompt.md` | `.github/prompts/` | `prompts/ios/swiftui/ios-expert-patterns.prompt.md` |
| `ios-quality-analyze.md` | `.github/prompts/` | `prompts/ios/swiftui/ios-quality-analyze.prompt.md` |
...
| `python-quality-skill/SKILL.md` | `.github/skills/python-quality-skill/SKILL.md` | `skills/backend/python/python-quality/SKILL.md` |
| quality rules critical/high/medium/low | `.github/python-quality-rules/` | `skills/backend/python/python-quality/references/` |
| `python-expert-pattern.agent.md` | `.github/agents/` | `agents/backend/python/python-expert-pattern.agent.md` |
| `python-quality.agent.md` | `.github/agents/` | `agents/backend/python/python-quality.agent.md` |
| `python-expert-patterns.prompt.md` | `.github/prompts/` | `prompts/backend/python/python-expert-patterns.prompt.md` |
| `python-quality-analyze.md` | `.github/prompts/` | `prompts/backend/python/python-quality-analyze.prompt.md` |
...
2. `skills/android/compose/android-quality/` existe con SKILL.md + quality rules (critical/high/medium/low) como referencias.
3. `agents/android/compose/android-expert-pattern.agent.md` existe con handoff a `android-patterns`.
4. `agents/android/compose/android-quality.agent.md` existe con handoff a `android-quality`.
5. `agents/android/compose/android-compose-expert.agent.md` (existente US-012) actualizado para delegar también en `android-patterns` y `android-quality`.
6. `skills/ios/swiftui/ios-quality/` existe con SKILL.md + quality rules iOS como referencias.
7. `agents/ios/swiftui/ios-quality.agent.md` existe.
8. `agents/ios/swiftui/ios-swiftui-expert.agent.md` (existente US-013) actualizado para delegar también en `ios-quality`.
9. `skills/backend/python/python-patterns/` existe con SKILL.md + 5 referencias por categoría + overview.md con Mermaid.
10. `skills/backend/python/python-quality/` existe con SKILL.md + quality rules Python como referencias.
