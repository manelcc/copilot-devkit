---
name: devkit-kotlin-mcp-server-generator
description: >-
...
Consultar skill `devkit-postgresql-crud` para los patrones detallados.
...
Consultar skill `devkit-unit-testing-kotlin` para los patrones detallados.
