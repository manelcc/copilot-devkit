---
name: "devkit-unit-testing-kotlin"
description: >
...
non_triggers:
  - Implementación de lógica de negocio (usar clean-architecture o devkit-kotlin-mcp-expert)
  - Configuración de pipelines CI/CD (usar las skills *-cicd)
  - Revisión de calidad de código (usar devkit-clean-code-guardian)
---
...
- [ ] **UT-09** Cada `TC-U-XXX` del fichero `doc/test-cases/TC-<US>-*.md` tiene su test correspondiente

---

## Generación de tests guiada por Test Cases

Cuando existe un fichero `doc/test-cases/TC-<US-number>-*.md` para la US actual, los tests se generan en dos pasos:
