...
# Skill: Logging Kotlin — Middleware Kotlin/Ktor

## Fuentes de verdad obligatorias

- `src/main/kotlin/<org>/<project>/core/logging/Logging.kt`
- `src/main/resources/logback.xml`
...
```xml
<logger name="com.example.middleware.infrastructure.client" level="DEBUG"/>
```
