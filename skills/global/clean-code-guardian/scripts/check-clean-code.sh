...
#
# Uso:
#   .github/skills/clean-code-guardian/scripts/check-clean-code.sh [ruta.kt|directorio]
#
...
Usage:
  bash skills/global/clean-code-guardian/scripts/check-clean-code.sh [ruta.kt|directorio]
