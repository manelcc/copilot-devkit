...
## Connects To
- **book foundations**: introduces prerequisites used by this chapter's methods.
- **Ch 2**: extends these methods into the next operational layer.
