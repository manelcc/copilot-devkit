...
## Connects To
- **Ch 2**: introduces prerequisites used by this chapter's methods.
- **Ch 4**: extends these methods into the next operational layer.
